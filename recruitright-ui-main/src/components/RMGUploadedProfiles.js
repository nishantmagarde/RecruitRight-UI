...
class RMGUploadedProfiles extends Component {
    constructor() {
        super();
        this.state = { 
            requirements:[],
  ...
  all = (e) => {
    ...
    let employee = {sessionId:global.sessionId} ;
    console.log(employee);
    EmployeeService.rmgUploadedProfiles(employee).then(res => {
        let s=res.data;
        console.log(s);
        console.log(s.requirements);
  ...
  active = (e) => {
    ...
    let employee = {sessionId:global.sessionId} ;
    console.log(employee);
    EmployeeService.ActiveUserProfiles(employee).then(res => {
        let s=res.data;
        console.log(s);
        console.log(s.requirements);
        this.setState({requirements:s.userProfiles});
...
selected = (e) => {
    ...
    let employee = {sessionId:global.sessionId} ;
    console.log(employee);
    EmployeeService.SelectedUserProfiles(employee).then(res => {
        let s=res.data;
        console.log(s);
        console.log(s.requirements);
        this.setState({requirements:s.userProfiles});
...
progress = (e) => {
    ...
    let employee = {sessionId:global.sessionId} ;
    console.log(employee);
    EmployeeService.InProgressUserProfiles(employee).then(res => {
        let s=res.data;
        console.log(s);
        console.log(s.requirements);
        this.setState({requirements:s.userProfiles});
...
export default RMGUploadedProfiles;